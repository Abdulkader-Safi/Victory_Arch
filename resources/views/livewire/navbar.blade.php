...
<nav x-data="{mobileMenu: false}"
    ...
    <div class="w-full flex justify-between items-center px-10 lg:px-0">
        <div class="w-full">
        ...
        <div class="w-full flex justify-end items-center gap-5 lg:gap-0">
            <a
                class="btn bg-primary/90 hover:bg-primary focus:ring-1 focus:ring-secondary/50 rounded-lg px-4 py-2 border-0 text-white">
                Start Project
            </a>
